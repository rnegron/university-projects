...
ALTER TABLE `Diseño_de_Escenografia` ADD CONSTRAINT `Diseño_de_Escenografia_fk0` FOREIGN KEY (`d_id`) REFERENCES `Diseñadores_de_Escenografia`(`d_id`);

ALTER TABLE `Diseño_de_Escenografia` ADD CONSTRAINT `Diseño_de_Escenografia_fk1` FOREIGN KEY (`obra_id`) REFERENCES `Obras`(`obra_id`);
